...
wk.register({
    ...
    c = {
        name = "clap",
        l = {'<cmd>Clap<cr>', 'main-menu'},
        h = {'<cmd>Clap help_tags<cr>', 'help-tags'},
    },
    d = {
    ...
    l = {
        ...
        dj   = {'<cmd>lua vim.diagnostic.goto_next()<cr>',   'lsp-diag-next'},
        dk   = {'<cmd>lua vim.diagnostic.goto_prev()<cr>',   'lsp-diag-prev'},
