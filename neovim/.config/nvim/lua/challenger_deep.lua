...
function challenger_deeper.load_syntax()
      local syntax = {
        ...
        SpellBad = {fg=challenger_deeper.dark_red,sp=challenger_deeper.dark_red,cterm='underline',gui='underline'};
        ...
        SpellLocal = {fg=challenger_deeper.dark_green,sp=challenger_deeper.dark_gren,cterm='underline',gui='underline'};
      }
      return syntax
    end
